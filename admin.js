...
function clearVisa(){edit.visa=null;$('#visaFormTitle').textContent='Add visa card';['#vCountry','#vFlag','#vType','#vValidity','#vFee','#vDateLabel','#vDeadline','#vDesc','#vDocs'].forEach(sel=>$(sel).value='');$('#vDummyTicket').checked=true;$('#vCover').value='';$('#vDetails').value='';resetFileStates();resetDraft('visa')}
