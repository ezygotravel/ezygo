(() => {
  ...
  function cardMarkup(c,index=999) {
    ...
    const dummyTicket=c.dummy_ticket?`<div class="dummyTicket"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7.5h16v9H4z"/><path d="M8 7.5v9M16 7.5v9"/><path d="m10.1 12 1.3 1.3 2.8-3"/></svg><div><strong>Dummy Ticket</strong><small>Temporary flight itinerary support for visa application.</small></div></div>`:'';
