...
- Run it once.
- This creates visa sections, visa cards, packages, feedback and the site-media Storage bucket.
- Existing textual visa/package content is seeded. Images are intentionally not hot-linked. Upload them from Admin so the live site uses Supabase Storage.
...
- Upload card/package images from Admin. They are stored in Supabase Storage.
- Use the up/down controls to change card/package/visa-section order.
